...
BITPAY_TOKEN=
  ...
  <input class="form-control" name="username" value="<?php echo $username; ?>" placeholder="Enter random value!" type="text"><br>
  <input class="form-control input-lg" name="license" placeholder="Enter random value!" type="text" ><br>
