...
} elseif ($_instance->childHasBeenRendered('TGzx5oc')) {
    $componentId = $_instance->getRenderedChildComponentId('TGzx5oc');
    $componentTag = $_instance->getRenderedChildComponentTagName('TGzx5oc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TGzx5oc');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('TGzx5oc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH C:\xampp\htdocs\invest\resources\views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>