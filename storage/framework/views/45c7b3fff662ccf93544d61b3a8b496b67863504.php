...
} elseif ($_instance->childHasBeenRendered('FBVdywk')) {
    $componentId = $_instance->getRenderedChildComponentId('FBVdywk');
    $componentTag = $_instance->getRenderedChildComponentTagName('FBVdywk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FBVdywk');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('FBVdywk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\invest\resources\views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>